...
async def verify_payment(
    ...
    try:
        ...
        order.order_status = "processing"  # Update order status after payment

        await db.flush()  # Ensure data is updated before commit
        await db.commit()
        ...
        print(f"Error verifying payment: {e}")  # Log error
